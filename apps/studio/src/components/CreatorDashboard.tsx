  ...
  return (
    <div className="studio-shell">
      ...
      <aside
        ...
        style={{ width: '16rem', alignItems: 'flex-start', padding: '1.25rem 1rem' }}
      >
        <a
          href="/"
          style={{
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at top right, rgba(26, 15, 60, 0.5), transparent 40%), var(--bg)',
        }}
      >
            ...
            <section className="studio-card" style={{ padding: '2rem' }}>
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{ width: '1px', background: 'var(--card-border)', margin: '0 0.5rem' }}
                  />
                  <select
                    style={{
                      background: 'transparent',
