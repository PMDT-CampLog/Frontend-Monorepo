  ...
  'inline-flex items-center justify-center gap-2 rounded-lg font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        secondary:
          'bg-surface-raised text-slate-900 dark:text-white border border-surface-overlay hover:bg-surface-overlay',
        ghost: 'text-slate-900 dark:text-white hover:bg-surface-raised',
        destructive: 'bg-red-600 text-white hover:bg-red-700',
        outline: 'border border-brand-500 text-brand-600 dark:text-brand-400 hover:bg-brand-500/10',
      },
      size: {
        sm: 'h-8 px-3 text-sm',
